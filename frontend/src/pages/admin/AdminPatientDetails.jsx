...
export default function AdminPatientDetails({ role }) {
...
useEffect(() => {
  ...
  useEffect(() => {
    const fetchAppointments = async () => {
      try {
        const response = await fetch(`${CONN.BACKEND_LOCAL}/admin/patient-data/details`, {
          method: "POST",
          headers: {
  ...
  const EMRForm = ({ appointmentId, selectedCategory }) => {
    ...
    const onFinish = async (values) => {
      ...
      switch (selectedCategory) {
        case 'anamnesis':
          endpoint = '/admin/patient-list/patient-details/emr-anamnesis';
          ...
          break;
        case 'diagnosis':
          endpoint = '/admin/patient-list/patient-details/emr-diagnosis';
          ...
          break;
        case 'kehamilan':
          endpoint = '/admin/patient-list/patient-details/emr-kehamilan';
          ...
          break;
        case 'tbParu':
          endpoint = '/admin/patient-list/patient-details/emr-tb';
          ...
          break;
        case 'lab':
          endpoint = '/admin/patient-list/patient-details/emr-lab';
      ...
      <div className="grid grid-cols-1 py-24 mx-12 min-h-fit">
        <div className="grid justify-between grid-cols-5 gap-x-8">
          <div className="grid items-start col-span-5">
            <div className="grid mb-4"><BackButton linkToPage="/admin/dashboard"/></div>
          </div>
          <div className="grid items-start col-span-5">
