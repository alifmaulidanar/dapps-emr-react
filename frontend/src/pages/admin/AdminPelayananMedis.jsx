...
export default function AdminPelayananMedis({ token }) {
  ...
  return (
    <>
      <div>
        ...
        <div className="grid justify-center w-12/12 grid-cols-1 mx-auto min-h-fit max-h-fit min-w-screen gap-x-8 gap-y-4">
