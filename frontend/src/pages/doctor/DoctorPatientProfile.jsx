...
function DoctorPatientProfile({ data, convert, foto }) {
  ...
  const patientDataProps1 = [
    ...
    { key: "tanggalLahir", value1: "Tanggal Lahir", value2: (<p>{new Date(convertedData.tanggalLahir).toLocaleDateString('id-ID', { weekday: 'long', day: 'numeric', month: 'long', year: 'numeric' })}</p>) },
    ...
    { key: "telpRumah", value1: "Telepon Rumah", value2: <p>{convertedData.telpRumah}</p> },
  ...
  const patientDataProps2 = [
    { key: "namaKerabat", value1: "Nama Kerabat", value2: <p>{convertedData.namaKerabat}</p> },
    { key: "nomorIdentitasKerabat", value1: "Nomor Identitas Kerabat", value2: <p>{convertedData.nomorIdentitasKerabat}</p> },
    { key: "tanggalLahirKerabat", value1: "Tanggal Lahir Kerabat", value2: <p>{new Date(convertedData.tanggalLahirKerabat).toLocaleDateString('id-ID', { weekday: 'long', day: '2-digit', month: 'long', year: 'numeric' })}</p> },
    { key: "genderKerabat", value1: "Jenis Kelamin Kerabat", value2: <p>{convertedData.genderKerabat}</p> },
    { key: "telpKerabat", value1: "Telepon Kerabat", value2: <p>{convertedData.telpKerabat}</p> },
    { key: "hubunganKerabat", value1: "Hubungan dengan Kerabat", value2: <p>{convertedData.hubunganKerabat}</p> },
    { key: "alamatKerabat", value1: "Alamat Kerabat", value2: <p>{convertedData.alamatKerabat}</p> },
    { key: "rtKerabat", value1: "RT Kerabat", value2: <p>{convertedData.rtKerabat}</p> },
    { key: "rwKerabat", value1: "RW Kerabat", value2: <p>{convertedData.rwKerabat}</p> },
    { key: "kelurahanKerabat", value1: "Kelurahan Kerabat", value2: <p>{convertedData.kelurahanKerabat}</p> },
    { key: "kecamatanKerabat", value1: "Kecamatan Kerabat", value2: <p>{convertedData.kecamatanKerabat}</p> },
    { key: "kotaKerabat", value1: "Kota Kerabat", value2: <p>{convertedData.kotaKerabat}</p> },
    { key: "posKerabat", value1: "Kode Pos Kerabat", value2: <p>{convertedData.posKerabat}</p> },
    { key: "provinsiKerabat", value1: "Provinsi Kerabat", value2: <p>{convertedData.provinsiKerabat}</p> },
    { key: "negaraKerabat", value1: "Negara Kerabat", value2: <p>{convertedData.negaraKerabat}</p> }
  ];
  return (
