...
export default function AdminAccount({ role }) {
  ...
  return (
    <>
      <div className="grid justify-center w-full min-h-screen grid-cols-2 px-4 mx-auto">
        <div className="col-span-2">
          <Form
            form={form}
            layout="vertical"
            className="grid items-center max-w-6xl grid-cols-2 mx-auto rounded gap-y-8 gap-x-8 h-fit"
            onFinish={onFinish}
          >
            {/* Address Pengguna */}
