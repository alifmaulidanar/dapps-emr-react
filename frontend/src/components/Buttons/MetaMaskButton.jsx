  ...
  const connectMetaMask = useCallback(async () => {
    ...
    try {
      ...
      openNotification(
        "success",
        "MetaMask Terhubung!",
        "MetaMask Anda berhasil terhubung ke jaringan blockchain Ganache",
        "topRight"
      );
      return signer;
    } catch (error) {
      ...
      alert(
        "Error connecting to Ganache. Please check the console for more details."
      );
    }
  }, []);
  ...
  return (
    <>
      ...
      <Button
        ...
        className="text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm p-5 text-center inline-flex items-center"
      >
        <svg
          aria-hidden="true"
